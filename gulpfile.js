	...
	gulp.parallel([
		gulp.series([
			...
			function runningWatch() {
				...
				gulp.watch(['./public/**/*', './resources/views/**/*', './public/*']).on('change', reload);
			}
		]),
...
gulp.task(
	...
	gulp.parallel([
		gulp.series([
			...
			'cleanTemp',
			function runningWatch() {
				gulp.watch('./resources/assets/views/**/*', gulp.series('views'));
				gulp.watch('./resources/assets/views/**/*', gulp.series('cleanTemp'));
				gulp.watch('./resources/assets/scss/**/*', gulp.parallel('styles'));
				gulp.watch('./resources/assets/js/**/*', gulp.parallel('webpack:dev'));
				gulp.watch(['./public/**/*', './resources/views/**/*', './public/*']).on('change', reload);
			}
